...
let tabData = [
  ...
  { name: "Ours OOD", buttons: [
    { name: "Ours", link: "./static/images/ours/ood/van_gogh_starry_night_generated_2.png", cond: "./static/images/ours/ood/van_gogh_starry_night_generated_2", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/munch_generated_2.png", cond: "./static/images/ours/ood/munch_generated_2", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/industrial_generated.png", cond: "./static/images/ours/ood/industrial_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/interstellar_generated.png", cond: "./static/images/ours/ood/interstellar_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/greenhouse_generated.png", cond: "./static/images/ours/ood/greenhouse_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/babel_generated_2.png", cond: "./static/images/ours/ood/babel_generated_2", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/alice6_generated.png", cond: "./static/images/ours/ood/alice6_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/alice3_generated.png", cond: "./static/images/ours/ood/alice3_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/abandoned_2_generated.png", cond: "./static/images/ours/ood/abandoned_2_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/lonelytree.png", cond: "./static/images/ours/ood/lonelytree", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/van_gogh_stary_night_generated.png", cond: "./static/images/ours/ood/van_gogh_stary_night_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/hotairballoon_generated.png", cond: "./static/images/ours/ood/hotairballoon_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/kitchen_generated.png", cond: "./static/images/ours/ood/kitchen_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/library_with_globe.png", cond: "./static/images/ours/ood/library_with_globe", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/munch_generated.png", cond: "./static/images/ours/ood/munch_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/skyline_generated.png", cond: "./static/images/ours/ood/skyline_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/snow_generated.png", cond: "./static/images/ours/ood/snow_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/library_with_books.png", cond: "./static/images/ours/ood/library_with_books", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/babel_generated.png", cond: "./static/images/ours/ood/babel_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/alice1_generated.png", cond: "./static/images/ours/ood/alice1_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/alice5_generated.png", cond: "./static/images/ours/ood/alice5_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/livingroom_generated.png", cond: "./static/images/ours/ood/livingroom_generated", text: ''},
    { name: "Ours", link: "./static/images/ours/ood/library_generated.png", cond: "./static/images/ours/ood/library_generated", text: ''},
  ] },
];
